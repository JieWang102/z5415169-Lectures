...
#with open(SRCFILE, mode='r') as fobj: #use it
    #cnts = fobj.read()
...
with open(DSTFILE, mode='w') as fobj: #w代表write
...
def print_lines_rstrip(pth):
    ...
    with open(pth) as fobj:
        for i, line in enumerate(fobj):
            print(f"line {i}: '{line.rstrip()}'") #rstrip表示去除空行
...
#89-98 are the most important part of this file.