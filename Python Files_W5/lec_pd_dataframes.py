...
# ----------------------------------------------------------------------------
#   Create a dataframe #将上面两个series合并起来
# ----------------------------------------------------------------------------
# Data Frame with close and Bday columns
df  = pd.DataFrame({'Close': prc_ser, 'Bday': bday_ser}) #key用列的名称表示，value用series表示
#print(df)
#print()
...
# to a new variable.
#print()
y = ser_sort_inplace.sort_index(inplace=True) #改变原本顺序但y不会有任何产出
